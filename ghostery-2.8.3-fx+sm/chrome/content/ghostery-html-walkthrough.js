...
ghostery.wizard = {
	...
	CATEGORIES: {
		...
		'tracker': {'full': 'Trackers', 'pop': 'An element that serves no page purpose other than a tracking beacon (conversion pixel, audience segmentation pixel, etc) falls into Trackers category'},
