...
ghostery.translator = {
	...
	'en': {
		...
		'settings.showsources':'Show bug script sources',
		'settings.showsources.extra':'(in the browser popup)',
		...
		'settings.tab.update_options.desc': "Ghostery routinely updates its library of <b>third-party elements</b> (advertisements, tracking pixels, widgets, etc.) or <b>3pes</b>, for short.",
		'settings.tab.blocking.note': "Ghostery groups <acronym title='3rd-party elements'>3pes</acronym> into categories. Click on a category row to browse <acronym title='3rd-party elements'>3pes</acronym> in that category. Mark checkboxes to block, click element names for more information.",
		...
		'settings.whitelist.desc':'You can specify a list of sites where Ghostery will not block any <acronym title="3rd-party elements">3pes</acronym> or cookies.',
		...
		'settings.bugs.note': 'When you block a <acronym title="3rd-party element">3pes</acronym>, that element is prevented from communicating with its third-party provider.',
		...
		'walkthrough.desc.intro.2':'Ghostery looks for third party page elements (which we call "3pes") on the web pages you visit. These can be things like social network plugins, advertisements, invisible pixels used for tracking and analytics, etc. Ghostery notifies you that these things are present, and which companies operate them. You can learn more about these companies, and if you wish, choose to block the 3pes they operate. <br><br>This quick walkthrough will highlight some of Ghostery\'s options and give you a chance to set things up straight-away. You can change any of these decisions (and view more options) by visiting the Ghostery options menu at any time. If you have any questions during the process, drop us a line at <a href="mailto:support@ghostery.com" target="_blank">support@ghostery.com</a>.',
		...
		'walkthrough.desc.blocking.1':'Ghostery can prevent the page elements it detects from running in your browser. 3pes that are blocked will appear crossed out in the notification bubble. Blocking 3pes will prevent them from running in your browser, which can help control how your behavioral data is tracked.',
	...
	'de': {
		...
		'settings.tab.update_options': 'Auto Update',
		'settings.tab.update_options.desc': 'Ghostery routinely updates its library of third-party elements (advertisments, tracking pixels, widgets, etc.) or <b>3pes</b>, for short.',
		...
		'walkthrough.desc.notification.1':'Wenn Ghostery 3pes auf einer Seite, die Sie gerade besuchen, erkennt, zeigt es die Unternehmen, von denen diese Elemente stammen, in einem violetten Kästchen in der oberen rechten Bildschirmecke an. Wenn Sie Ghostery lieber im Hintergrund laufen lassen möchten, können Sie das Kästchen unten abwählen. Im Optionsmenü von Ghostery finden Sie weitere Möglichkeiten, das violette Kästchen an Ihre Anforderungen anzupassen.',
		'walkthrough.checkbox.notification':'Klicken Sie hier, um die Warnmeldung zu aktivieren',
		'walkthrough.desc.autoupdatebuglist.1':'Ghostery erweitert und überarbeitet regelmäßig unsere Liste mit Unternehmen, die Tracker, Werbeserver, Analytics-Services, Seitenwidgets und andere 3pes betreiben. Sie können diese Liste im Optionsmenü von Ghostery manuell aktualisieren oder Sie können den automatischen Aktualisierungsservice von Ghostery aktivieren, der regelmäßig Überprüfungen auf Neuzugänge zur Bibliothek von Ghostery durchführt und diese automatisch zur Liste hinzufügt.',
		'walkthrough.checkbox.autoupdatebuglist':'Klicken Sie hier, um die automatische Aktualisierung der Bibliothek zu aktivieren',
		'walkthrough.desc.blocking.1':'Ghostery kann verhindern, dass die gefundenen Seitenelemente in Ihrem Browser ausgeführt werden. Blockierte 3pes werden im Hinweis durchgestrichen angezeigt. Wenn 3pes blockiert werden, werden sie nicht in Ihrem Browser ausgeführt, wodurch Sie besser kontrollieren können, wie Ihre interessenbasierten Daten nachverfolgt werden. Bedenken Sie, dass einige 3pes auch nützlich sein können, z. B. Feed-Widgets für soziale Netzwerke oder browserbasierte Spiele ... Blockieren kann also auch unbeabsichtigte Auswirkungen auf die Sites, die Sie besuchen, haben.',
	...
	'ru': {
		...
		'settings.tab.blocking.note': 'Ghostery группирует элементы в категории. Нажмите на категорию, чтобы просмотреть все 3pes в этой категории. Нажмите на флажкок, чтобы блокировать, щелкните имя элемента для получения дополнительной информации о нём.',
